...
MangaDatabaseItemDescription _$MangaDatabaseItemDescriptionFromJson(
        Map<String, dynamic> json) =>
    MangaDatabaseItemDescription(
      json['text'] as String,
      json['source_name'] as String,
    );

Map<String, dynamic> _$MangaDatabaseItemDescriptionToJson(
        MangaDatabaseItemDescription instance) =>
    <String, dynamic>{
